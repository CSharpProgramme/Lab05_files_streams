...
namespace SequentialAccessText
{
    public partial class BankUIForm : Form
    {
        ...
        //enumaration constants specify TextBox indices
        ...
        public void ClearTextBoxes()
        {
            ...
            foreach(Control guiControl in Controls)
            {
                ...
                //guiControl as TextBox = safe type casting
                //? = null conditional operator. only call Clear()
        ...
        {
            //determines wheter string array has correct length
