...
namespace LINQToFileDirectory
{
    ...
    {
        //store extension found, and number of each extension found
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
            ...
            {
                //show error if user does not specified path exists
            ...
            else
            {
                ...
                direcrtoryTextBox.Text = currentDirectory; //show directory
                ...
                foreach (var current in found.Keys)
                {
                    ...
                    resultTextBox.AppendText($"Found {found[current]} {current} files." + Environment.NewLine);
                }
        ...
        private void SearchDirectory(string folder)
        {
            ...
            {
                SearchDirectory(subdirectories);
            }
        }
